...
import com.ecm.legacy.repository.CategoryRepository;
import com.ecm.legacy.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService{
	...
	public Product createProduct(CreateProductRequest req, Seller seller) {
		...
		com.ecm.legacy.model.Category category1=categoryRepository.findByCategoryId(req.getCategory());
		
		if(category1==null) {
			com.ecm.legacy.model.Category category=new com.ecm.legacy.model.Category();
			category.setCategoryId(req.getCategory());
			category.setLevel(1);
			category1=categoryRepository.save(category);
		}
		
		com.ecm.legacy.model.Category category2=categoryRepository.findByCategoryId(req.getCategory());
		 ...
		 com.ecm.legacy.model.Category category3=categoryRepository.findByCategoryId(req.getCategory());
