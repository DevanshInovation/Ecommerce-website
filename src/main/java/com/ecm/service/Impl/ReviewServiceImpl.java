...
import com.ecm.repository.ReviewRepository;
import com.ecm.request.CreateReviewRequest;
import com.ecm.service.ReviewService;
...
public class ReviewServiceImpl implements ReviewService{
	...
	public Review createReview(CreateReviewRequest req, User user, Product product) {
	    ...
	    review.setRating(req.getReviewRatings());
	...
	public Review updateReview(Long reviewId, String reviewText,
	                           double rating, Long userId) throws Exception {
